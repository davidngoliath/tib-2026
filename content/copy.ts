...
export const copy: Record<Locale, Dict> = {
  en: {
    ...
    braveCamp: {
      title: "Brave Camp\nReturns\nAug. 16 - 23 2026",
      body: "Brave Camp is a weeklong, customized camp experience that gets campers outside of their comfort zone, to take part in something new while making new friends, and be inspired by Mother Nature!",
    ...
    braveCampAbout: {
      ...
      features: {
        braveCamp: {
          title: "Brave Camp",
          body: [
            "Brave Camp is a weeklong experience designed to help kids step outside of their comfort zones, try new things, build meaningful friendships, and grow through adventure in nature.",
